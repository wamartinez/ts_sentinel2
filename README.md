...
The complete report can be found [here](https://wamartinez.github.io/ts_sentinel2/Document/Thesis_index_wm.pdf)
...
1. LULC classification using RF and SVM in python: a glance of static classification using sentinel 2 Imagery and extracted training sampling of Cos map 2015: [here](https://wamartinez.github.io/ts_sentinel2/ToolPython/Classification_weighted_landcover.html)

2. A brief introduction of the results of the classification performance using automatic training sample extraction from old maps for intra-annual LULC mapping at central of Portugal: [here](https://wamartinez.github.io/ts_sentinel2/ToolR/UncertantyMaps.html)
